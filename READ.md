...
除了传统的赞赏方式，连载网还将采用 POWR 奖励算法，给内容贡献者奖励  READ 。写作即贡献，小说作家通过创作来获得代表阅读权益的 READ，整个过程由作家创作行为、读者投票等非平台因素而决定，规则公开、透明。
...
注：免费阅读并不代表全面开放，被搜索引擎随意收录，也会有公众版和 VIP 版之分，不过连载网上的 VIP 章节和其他平台的不同，阅读 VIP 内容并不要消费 READ  。
